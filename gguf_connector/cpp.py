...
if gguf_files:
    ...
    try:
        ...
        icon = PhotoImage(file=os.path.join(os.path.dirname(__file__),
            'logo.png'))
        ...
        def submit(i):
            ...
            console = Console()
            console.print(
                '*note: [green]it might show: (Not Responding) and/or keep spinning; but running in background still; please be patient.'
                )
