...
def download_7z_file(url, output_filename):
    ...
    if response.status_code == 200:
        ...
        print(
            'Failed to download the file. Seems encountering a connection problem.'
            )
ver = 'https://raw.githubusercontent.com/calcuis/gguf-pack/main/version.json'
v = read_json_file(ver)
url = (
    f"https://github.com/calcuis/gguf-pack/releases/download/{v[0]['version']}/GGUF_windows_portable.7z"
    )
